...
<section>
    ...
    <p style="text-align:justify"> VerCors transforms the verification problem of programs written in a
        ...
        top of existing verification technology, notably the <a
                href="http://www.pm.inf.ethz.ch/research/viper.html" style="color:blue">Viper</a> framework. The
        VerCors tool set reuses existing verification technology, notably the Viper framework, by transforming
        the verification problem of programs written in a high-level programming language into a verification
        problem in the intermediate language of Viper. It supports the verification of functional correctness of
        a program using a heterogeneous concurrency model, and of kernels using barriers and atomic operations
    ...
    <p style="text-align:justify"> The current main input languages for VerCors are Java, OpenCL and PVL: it
        ...
        supported. PVL is a procedural toy language used for teaching and quick prototyping of new verification
        features. For Java, we only provide limited support related to inheritance, as this is orthogonal to
        concurrency-related aspects. The support for OpenCL only covers the verification of kernels, including
        barrier synchronisation and atomic operations, It does not support reasoning about host code yet.
        However, supporting those features of Java and OpenCL would mainly be an engineering effort (in
    ...
    <p style="text-align:justify"> Currently the Viper tool set is the main back-end of VerCors. Viper supports
        ...
        provides two styles of reasoning, using verification conditions generation (via Boogie), and by symbolic
        execution. The symbolic execution engine is the most powerful, and provides support for features such as
        quantified permissions, which we heavily rely upon. In earlier versions of VerCors, we used Chalice as
        the main back end, but its functionality is subsumed by Viper.
    </p>
</section>
